...
*/
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canEditRoleClaims = await AuthService.HasPermissionAsync(state.User, AppAction.Update, Resource.RoleClaims);
        _canSearchRoleClaims = await AuthService.HasPermissionAsync(state.User, AppAction.View, Resource.RoleClaims);
...
public record PermissionViewModel : Permission
{
