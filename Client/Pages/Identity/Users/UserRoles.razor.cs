...
public partial class UserRoles
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canEditUsers = await AuthService.HasPermissionAsync(state.User, AppAction.Update, Resource.Users);
        _canSearchRoles = await AuthService.HasPermissionAsync(state.User, AppAction.View, Resource.UserRoles);
