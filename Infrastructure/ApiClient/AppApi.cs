...
namespace Infrastructure.ApiClient
{
    ...
    public partial interface ICardsClient : IApiService
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> GenerateQRCodeAsync(string qRCodeText);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> GenerateQRCodeAsync(string qRCodeText, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class CardsClient : ICardsClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> GenerateQRCodeAsync(string qRCodeText)
        {
            return GenerateQRCodeAsync(qRCodeText, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> GenerateQRCodeAsync(string qRCodeText, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/cards?");
            if (qRCodeText != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("qRCodeText") + "=").Append(System.Uri.EscapeDataString(ConvertToString(qRCodeText, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
